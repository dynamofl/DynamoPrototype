...
import { Breadcrumb } from '../../components/patterns/ui-patterns/breadcrumb';
...
export const DifferentPaths: Story = {
  render: () => (
    <div className="space-y-6 w-full max-w-2xl">
      <div>
        <h3 className="text-[0.8125rem]  font-medium mb-2">AI Systems</h3>
      ...
      <div>
        <h3 className="text-[0.8125rem]  font-medium mb-2">Create System</h3>
      ...
      <div>
        <h3 className="text-[0.8125rem]  font-medium mb-2">Configuration</h3>
        <MemoryRouter initialEntries={['/ai-systems/create/configuration']}>
          <Breadcrumb />
        </MemoryRouter>
      </div>
      ...
      <div>
        <h3 className="text-[0.8125rem]  font-medium mb-2">Settings</h3>
