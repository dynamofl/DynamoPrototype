...
const meta: Meta<typeof TablePattern> = {
  title: 'Patterns/Table Patterns/Table Pattern',
    ...
    return (
      <div className="space-y-4">
        <div className="p-4 bg-blue-50 rounded">
          ...
          <p className="text-[0.8125rem]  text-blue-500 mt-2">
    ...
    return (
      <div className="space-y-4">
        <div className="p-4 bg-green-50 rounded">
          ...
          <p className="text-[0.8125rem]  text-green-500">Displaying {mockRows.length} AI systems with all cell types.</p>
        </div>
                      ...
                      <td key={column.key} className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                        {column.type === 'badge' ? (
                          ...
                          <div className="flex gap-2">
                            <button className="inline-flex items-center justify-center rounded-md text-[0.8125rem]  font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-gray-0 hover:bg-accent hover:text-accent-foreground h-9 px-3">
                              Edit
                            </button>
                            <button className="inline-flex items-center justify-center rounded-md text-[0.8125rem]  font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-destructive text-destructive-foreground hover:bg-destructive/90 h-9 px-3">
                              Delete
                            </button>
                          </div>
                        ) : (
    ...
    return (
      <div className="space-y-4">
        <div className="p-4 bg-green-50 rounded">
          ...
          <p className="text-[0.8125rem]  text-green-500">This should definitely show the data since it's the real component.</p>
        </div>
    ...
    return (
      <div className="space-y-4">
        <div className="p-4 bg-green-50 rounded">
          ...
          <p className="text-[0.8125rem]  text-green-500">Using storageConfig (not customStorage) like the real working tables.</p>
        </div>
    ...
    return (
      <div className="space-y-4">
        <div className="p-4 bg-purple-50 rounded">
          ...
          <p className="text-[0.8125rem]  text-purple-500">Displaying {staticData.length} AI systems with all cell types.</p>
        </div>
              ...
              <tbody className="[&_tr:last-child]:border-0">
                {staticData.map((row) => (
                  <tr key={row.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                    ...
                    <td className="p-4 align-middle text-[0.8125rem]  text-gray-600">
                    ...
                    <td className="p-4 align-middle text-[0.8125rem]  text-gray-600">{row.createdAt}</td>
                    <td className="p-4 align-middle">
                      <span className="text-lg">
                        {row.health === 'healthy' ? '✅' :
