...
export const ContentVisibility: Story = {
  ...
  render: () => (
    <div className="space-y-4 w-96">
      <div>
        <h4 className="text-sm font-medium mb-2">Both Title and Description</h4>
        <Banner
      ...
      <div>
        <h4 className="text-sm font-medium mb-2">Title Only</h4>
        <Banner
      ...
      <div>
        <h4 className="text-sm font-medium mb-2">Description Only</h4>
        <Banner
      ...
      <div>
        <h4 className="text-sm font-medium mb-2">Actions Only (No Text)</h4>
        <Banner
  ...
  render: () => (
    <div className="p-6 space-y-8 w-full bg-gray-50 min-h-screen">
      <div className="bg-white p-4 rounded border">
        <h4 className="text-sm font-medium mb-4">Width: "fit" (auto-width with max-width)</h4>
      ...
      <div className="bg-white p-4 rounded border">
        <h4 className="text-sm font-medium mb-4">Width: "full" (100% container width)</h4>
