    ...
    switch (variant) {
      case 'settings':
        return {
          ...
          menuButton: 'flex items-center gap-2 px-2 py-1.5 text-[0.8125rem]  font-450 text-gray-600 hover:text-gray-900 hover:bg-gray-50',
          activeMenuButton: 'flex items-center gap-2 px-2 py-1.5 text-[0.8125rem]  font-450 bg-gray-50 text-gray-900 rounded-md'
        }
      default:
        return {
          container: 'w-64 border-r border-gray-200 bg-white',
