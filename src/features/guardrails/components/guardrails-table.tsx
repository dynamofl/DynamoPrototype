          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-[0.8125rem]  text-gray-900">{viewingGuardrail.name}</p>
              </div>
              <div>
                <label className="text-[0.8125rem]  font-450 text-gray-600">Category</label>
                <p className="text-[0.8125rem]  text-gray-900">{viewingGuardrail.category}</p>
              </div>
              <div>
                <label className="text-[0.8125rem]  font-450 text-gray-600">Status</label>
                <p className="text-[0.8125rem]  text-gray-900">{viewingGuardrail.status}</p>
              </div>
              <div>
                <label className="text-[0.8125rem]  font-450 text-gray-600">Created</label>
                <p className="text-[0.8125rem]  text-gray-900">{viewingGuardrail.createdAt}</p>
              </div>
            </div>
            <div>
              <label className="text-[0.8125rem]  font-450 text-gray-600">Description</label>
              <p className="text-[0.8125rem]  text-gray-900">{viewingGuardrail.description}</p>
            </div>
            <div>
              <label className="text-[0.8125rem]  font-450 text-gray-600">Content</label>
              <p className="text-[0.8125rem]  text-gray-900 whitespace-pre-wrap">{viewingGuardrail.content}</p>
            </div>
          </div>
        )}
      </ViewEditSheet>
        ...
        {editingGuardrail && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-[0.8125rem]  font-450 text-gray-600">Name</label>
                <p className="text-[0.8125rem]  text-gray-900">{editingGuardrail.name}</p>
              </div>
              <div>
                <label className="text-[0.8125rem]  font-450 text-gray-600">Category</label>
                <p className="text-[0.8125rem]  text-gray-900">{editingGuardrail.category}</p>
              </div>
            </div>
