      ...
      <div className="space-y-6 mt-6">
        ...
        <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
          ...
          <div>
            ...
            <p className="text-[0.8125rem]  text-gray-600">API Provider</p>
          </div>
        </div>
        ...
        {validationStatus === 'success' && (
          <div className="flex items-center space-x-2 p-3 bg-green-50 border border-green-200 rounded-md">
            ...
            <span className="text-[0.8125rem]  text-green-800">API key validated successfully!</span>
          </div>
        )}
        ...
        {validationStatus === 'error' && (
          <div className="flex items-center space-x-2 p-3 bg-red-50 border border-red-200 rounded-md">
            ...
            <span className="text-[0.8125rem]  text-red-800">API key validation failed</span>
          </div>
        )}
