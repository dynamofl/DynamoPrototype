      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        {data.jailbreak ? (
          <SummaryMetricCardDetailed
            ...
            aiSystemAvg={`${data.jailbreak.latestAISystemOnlySuccessRate?.toFixed(0) ?? 0}%`}
            aiSystemGuardrailAvg={data.jailbreak.latestWithGuardrailsSuccessRate !== undefined
              ? `${data.jailbreak.latestWithGuardrailsSuccessRate.toFixed(0)}%`
              : undefined}
        ...
        {data.compliance ? (
          <SummaryMetricCardDetailed
            ...
            aiSystemAvg={`${data.compliance.latestAISystemOnlySuccessRate?.toFixed(0) ?? 0}%`}
            aiSystemGuardrailAvg={data.compliance.latestWithGuardrailsSuccessRate !== undefined
              ? `${data.compliance.latestWithGuardrailsSuccessRate.toFixed(0)}%`
              : undefined}
