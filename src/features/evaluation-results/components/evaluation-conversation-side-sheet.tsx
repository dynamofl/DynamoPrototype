...
import { EvaluationConversationDetail } from './evaluation-conversation-detail'
import type { EvaluationRecord } from '../types'

interface EvaluationConversationSideSheetProps {
  open: boolean
...
export function EvaluationConversationSideSheet({
  open,
  onOpenChange,
  record,
  allRecords,
  ...
  onNavigatePrevious,
  onExpand
}: EvaluationConversationSideSheetProps) {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[600px] sm:max-w-[600px] p-0 flex flex-col [&>button]:hidden">
        ...
        <div className="flex-1 overflow-hidden">
          <EvaluationConversationDetail record={record} />
        </div>
      </SheetContent>
    </Sheet>
  )
